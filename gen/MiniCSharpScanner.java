...
public class MiniCSharpScanner extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FOR", "WHILE", "BREAK", "RETURN", "READ", "WRITE", "NEW", "LBRACE", 
	...
	public MiniCSharpScanner(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "MiniCSharpScanner.g4"; }
